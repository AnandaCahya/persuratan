    ...
    return (
        <div className="w-[300px] h-full grid grid-rows-3 p-10 rounded-r-3xl bg-[#303030] fixed">
            ...
            <div className="flex flex-col justify-center gap-3">
                <Link className="w-full bg-[#454545] py-3 px-4" href={"/dashboard"}>Dasbor</Link>
                <Link className="w-full bg-[#454545] py-3 px-4" href={"/pegawai"}>Pegawai</Link>
                <Link className="w-full bg-[#454545] py-3 px-4" href={"/surat"}>Surat</Link>
            </div>
            <div className="flex flex-col justify-center">
